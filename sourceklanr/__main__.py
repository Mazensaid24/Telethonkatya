...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["Source_Katya","MIIKa3","C1_F5","Fv_av","P5_HH","Groupiqthon"]
    ...
    print(f"<b> 🔱 اهلا بك لقد نصبت تليثون كاتيا بنجاح ☸️ اذهب الى قناتنا لمعرفة المزيـد v8.3 🔆. </b>\n CH : https://t.me/Source_Katya ")
    await verifyLoggerGroup()
